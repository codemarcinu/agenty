...
def make_llm_chat_mock(stream_content: str, non_stream_content: str | None = None):
    """
...
async def test_search_agent(mock_llm_client, mock_perplexity_search):
    ...
    # Mock DuckDuckGoSearchProvider and WikipediaSearchProvider
    from backend.agents.tools.search_providers import (
        DuckDuckGoSearchProvider,
        WikipediaSearchProvider,
    )

    async def mock_search_provider(self, query, *args, **kwargs):
        return [
            {
                "title": "Python language",
                "url": "http://example.com",
                "snippet": "Wyniki dla 'Python'.",
                "source": "duck",
    ...
    DuckDuckGoSearchProvider.search = mock_search_provider
    WikipediaSearchProvider.search = mock_search_provider
