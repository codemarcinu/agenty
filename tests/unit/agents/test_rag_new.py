#!/usr/bin/env python3
"""
Test RAG processor z nową konfiguracją vector store
"""
...
async def test_rag_processor_new():
    """Test RAG processor z nową konfiguracją"""
    try:
...
if __name__ == "__main__":
    asyncio.run(test_rag_processor_new())
