...
class AgentCircuitBreaker:
    ...
    async def run(
        ...
        try:
            ...
            # Inne nieoczekiwane błędy zostaną obsłużone przez pybreaker,
            # jeśli nie są wykluczone
            logger.error(
    ...
    def _sync_wrapper(
        ...
        def _execute_sync() -> None:
            ...
            # Najlepiej użyć istniejącego loopa, ale to wymaga,
            # by _sync_wrapper był wywoływany w kontekście loopa.
