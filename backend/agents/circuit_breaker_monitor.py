...
from agents.circuit_breaker_wrapper import AgentCircuitBreaker
    ...
    def get_health_status(self) -> dict[str, Any]:
        ...
        for name, breaker in self.breakers.items():
            status[name] = {
                ...
                # Pybreaker nie udostępnia failure_count i last_failure_time
                # bezpośrednio w API CircuitBreaker
