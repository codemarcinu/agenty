...
class IntentTrainer:
    ...
    def create_label_map(self, intents: list[str]) -> dict[str, int]:
        ...
        return {intent: i for i, intent in enumerate(sorted(set(intents)))}


# Przykład użycia:
# from agents.ml_intent_detector import BERTIntentDetector
# from ml_training.intent_trainer import IntentTrainer
