...
class TestIntentDetectorNew:
    ...
    async def test_shopping_conversation_detection(self, detector, context) -> None:
        ...
        shopping_queries = [
            ...
            "Mam paragon z Lidla",  # To może być receipt_processing
        ...
        for query in shopping_queries:
            with patch("backend.core.llm_client.llm_client.chat") as mock_chat:
                ...
                # Elastyczne sprawdzanie - paragon może być receipt_processing
                if "paragon" in query.lower():
    ...
    async def test_error_handling(self, detector, context) -> None:
        ...
        with patch("backend.core.llm_client.llm_client.chat") as mock_chat:
            ...
            # Should fall back to some default intent
            assert intent.type is not None
